# follows rules of the language to generate random root and accompanying family 
...
def NounIV():
    global root
    global n_classIV
    global core_consonants, core_vowels
...
def logwords():
    ...
    f = open('/home/pi/Desktop/Conlang.txt', 'a')
...
while True:
    ...
    #displays family
    print( '[Core: ' + core + ' | Root: ' + root + '] Verb: ' + Verbs )
    print( 'NounI: ' + NounsI )
    print( 'NounII: ' + NounsII )
    print( 'NounIII: ' + NounsIII )
    print( 'NounIV: ' + NounsIV )
    print( 'NounV: ' + NounsV )
    print( 'NounVI: ' + NounsVI )
    
    #logs family in .txt file
    logwords()
    
    #repeats every five seconds or go one at a time.
    #sleep(600)
    break
