...
class Conjugate:
    ...
    def LogDataBase(word, Class, root, definition):
    ...
    def ConRecord(self):
        ...
        if word in ['Quit']:
            ...
            root = Strip2Root(word, Class)
            declination = Ndecline(word, Class, root)
            conjugation = ChooseTense(Class, root)
            LogDataBase(word, Class, root, definition)
